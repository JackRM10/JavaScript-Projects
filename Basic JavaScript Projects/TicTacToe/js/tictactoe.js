...
let activePlayer = "X";
//This array stores an array of moves. We use this to determne win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This function parses the selectedSquares array to search for win coditions.
        ...
        function checkWinConditions() {
            ...
            //This condition checks for a tie. IF none of this above conditions are met and
            ...
            //This function checks if an array includes 3 strings, Itused to check for each win condition.
        ...
        function computersTurn() {
            ...
            function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
                ...
                //Thi line indicates where the start of a lines x axis is.
                let x1 = coordX1,
                //This line indicates where the start of a lines y axis is.
                y1 = coordV1,
                //This line indicates where the ened of a lines x axis is.
                x2 = coordX2,
                //This line indicates where the start of a lines y axis is.
                y2 = coordY2,
                ...
                function animateLineDrawing() {
                    ...
                    c.lineWidth = 10;
                    //This methos sets the color of our line.
