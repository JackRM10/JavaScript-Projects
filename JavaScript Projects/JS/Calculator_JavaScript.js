...
function Handle_Operator(Next_Operator) {
    ...
    //then updtes the operator an exits from the function.
...
//This function updates the claculator screen with the contents of Display_Value
